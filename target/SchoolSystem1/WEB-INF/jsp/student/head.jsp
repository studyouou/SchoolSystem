...
<div class="container">
    <ul class="nav nav-pills nav-justified">
        ...
        <li class="dropdown">
            <a class="dropdown-toggle" id="personcenter" data-toggle="dropdown" href="#">个人中心
        ...
        <li><a href="/student/detail" id="infoquery">信息查询</a></li>
        <li><a href="/student/1/chooseSujectindex" id="choosesubject">选课</a></li>
        <li><a href="#">重修报名</a></li>
        <li><a href="#">成绩</a></li>
        <li><a href="#">学生评教</a></li>
    </ul>
